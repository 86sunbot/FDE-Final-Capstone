...
**Current state:** APPROVED for academic POC under `docs/stages/stage_04/07_G1_DECISION_RECORD.md`.
...
- Every work session updates `docs/CAPSTONE_PROGRESS_TRACKER.md` with tests, risks, decisions and the next executable action.
