...
The academic POC is complete. The lifecycle decision is **RESTRICT AND CHANGE**: retain the engineering IP and evidence, keep AI off, and do not conduct a real pilot until the seven CAPAs in `docs/stages/stage_20/02_INTERNAL_AUDIT_AND_CAPA.md` are closed through a new accountable gate sequence.
