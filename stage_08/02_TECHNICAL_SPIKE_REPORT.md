...
Test whether the most important O2/O3 architectural properties can be expressed simply before committing to detailed architecture. The spike is in `stage_08/spikes/decision_kernel.py`; focused tests are in `tests/test_option_spikes.py`.
