...
Situation: individualized CGT journeys require coordinated decisions across many systems. Complication: evidence conflicts, clocks differ, authority is distributed, and shadow work fills gaps. Question: how can teams obtain a trustworthy journey view and act safely? Answer direction: governed evidence, explicit authority, deterministic controls, and bounded decision support.

**Artifact-specific outcome:** Frame the problem in business terms before solution selection.

## Specification

| Element | Decision / requirement | Evidence | Status / boundary |
|---|---|---|---|
| Situation | Multi-system clinical/manufacturing/quality/logistics journey for one patient-specific therapy. | source_baseline/participant/CHALLENGE_BRIEF.md | Supported |
| Complication | Conflicting identity/state/time evidence plus manual shadow coordination. | source_baseline/docs/02_imperfection_layers.md | Supported |
| Question | How to reduce avoidable delay and manual reconstruction while preserving authority and safety? | Stage 02 synthesis | Problem frame |

## Required content coverage

| Required field | Case-specific answer | Disposition |
|---|---|---|---|
| Situation | CGT patient journey crosses many systems and decision owners. | Addressed |
| Complication | No globally reliable operational truth; conflicts and gaps require reconciliation. | Addressed |
| Question | How can evidence-backed journey state and safe action support be established? | Addressed |
| Answer hypothesis | Build a governed evidence/state/workflow foundation; use AI only where later justified. | Hypothesis |
| Assumption | Synthetic findings approximate a brownfield environment but are not production proof. | Explicit |
...
|---|---|---|---|
| Engagement need | source_baseline/participant/CHALLENGE_BRIEF.md | Stage 03 | High |
| Current-state issues | source_baseline/docs/02_imperfection_layers.md | Stage 03 | High |
| Architecture context | source_baseline/docs/03_architecture_current_state.md | Stage 03 | High |
...
**Stage exit contribution:** Concise evidence-backed problem and value frame.  
