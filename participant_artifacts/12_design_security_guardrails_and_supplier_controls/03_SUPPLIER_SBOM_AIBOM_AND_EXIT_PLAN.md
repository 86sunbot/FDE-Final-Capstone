...
The application uses Python standard library at its core. FastAPI/Uvicorn are optional demo-API dependencies. `requirements.txt` pins permitted ranges; `docs/stages/stage_14/SBOM.json` is generated from the installed environment used for verification and is not a signed production SBOM.
