...
Freeze evaluation scenarios, thresholds, harms, oversight and residual-risk expectations before solution selection.

**Artifact-specific outcome:** This participant folder formalizes the canonical Stage 07 evidence already completed under `docs/stages/stage_07/`.

## Specification

| Element | Decision / requirement | Evidence | Status / boundary |
|---|---|---|---|
| Canonical source | Preserve all Stage 07 documents and machine-readable outputs. | `docs/stages/stage_07/` | Source of truth |
...
|---|---|---|
| Stage 07 decision | `docs/stages/stage_07/` | High for current repository state |
...
- [x] Canonical Stage 07 artifacts are present.
