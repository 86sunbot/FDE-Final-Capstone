...
The canonical machine-readable requirement list is `requirements/requirements.csv`. `requirements/TRACEABILITY_MATRIX.csv` remains the evidence-to-CTQ chain and will be extended after implementation with code and test references.
