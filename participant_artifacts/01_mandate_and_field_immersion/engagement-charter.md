...
Investigate the inherited CGT patient-to-batch estate before selecting technology. The engagement is chartered around safer, more reliable and more scalable coordination, with explicit authority boundaries and evidence traceability.

**Artifact-specific outcome:** Define the work around business outcomes, field discovery and decision rights; do not assume AI, agents, RAG, or a new global system of record are required.

## Specification

| Element | Decision / requirement | Evidence | Status / boundary |
|---|---|---|---|
| Primary mandate | Reconstruct the current journey, authority model, evidence quality, and operational friction before solution design. | source_baseline/participant/CHALLENGE_BRIEF.md | Owner review required |
| Business outcome | Reduce patient-at-risk exposure, manual coordination, avoidable delay, and weak traceability. | source_baseline/docs/01_problem_context.md | Outcome hypothesis |
| Operational boundary | Decision support and orchestration only; Clinical and Quality authority remain outside the FDE/AI system. | source_baseline/AGENTS.md | Hard boundary |

## Required content coverage

| Required field | Case-specific answer | Disposition |
|---|---|---|
| Problem/opportunity | The estate spans clinical, manufacturing, quality, logistics, scheduling, and shadow channels with conflicting operational truth. | Addressed |
| Business outcome | Improve journey safety, reliability, speed, and traceability without weakening authority. | Sponsor validation pending |
| Engagement boundaries | Patient identification through infusion readiness; discovery/evidence first. | Addressed |
| Decision rights | Clinical and Quality retain consequential decisions. | Addressed; named owners TBD |
| Working assumptions | Synthetic evidence supports capstone design, not production approval. | Explicit |
| Evidence plan | Use repository paths/records/queries/tests and preserve source/version/time/conflict. | Addressed |
...
|---|---|---|---|
| Mandate and scope | source_baseline/participant/CHALLENGE_BRIEF.md | Stage 01 | High for synthetic assignment |
| Discovery expectations | source_baseline/participant/DISCOVERY_CHECKLIST.md | Stage 01 | High |
| Brownfield problem context | source_baseline/docs/01_problem_context.md | Stage 01 | High |
| Safety/authority guardrails | source_baseline/AGENTS.md | Stage 01 | High for repo rules; production authority not implied |
